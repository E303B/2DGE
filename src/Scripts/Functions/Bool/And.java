...
public class And extends BaseFunction {
        ...
        if (params.length > 2) {
            if(Tools.isBool(params[1].toString())&&Tools.isBool(params[2].toString())){
                ...
                Start.mainRunner.mainLogger
                    .error("Bool.And get invalid value type");
            }
        } else {
            Start.mainRunner.mainLogger
                    .error("Bool.And should be used with at least 3 argument, but " + params.length + " given");
        }
    }
